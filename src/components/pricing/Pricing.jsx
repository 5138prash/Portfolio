    ...
    <section className='pricing container section' id='pricing'>
      ...
      <div className='pricing_container grid'>
        ...
        <div className='pricing_item'>
          <img src={Image1} alt="Image1" className='pricing_img'/>
        ...
        <span className='badge'>Recommended</span>
          <img src={Image2} alt="Image1" className='pricing_img'/>
          <h3 className='pricing_plan'>Premium</h3>
          <p className='pricing_title'> Unlimited product including app itergration and more features</p>
        ...
        <div className='pricing_item'>
          <img src={Image3} alt="Image1" className='pricing_img'/>
